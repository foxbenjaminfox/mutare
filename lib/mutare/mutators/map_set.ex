defmodule Mutare.Mutators.MapSet do
  ...
  The two opposite ways to combine two sets — keep-everything-from-either vs keep-only-the-shared — so the swap tests whether the suite distinguishes union from intersection. Classic untested-edge territory when a test only exercises overlapping or disjoint inputs.
